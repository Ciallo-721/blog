...
updated: 2026-08-03
draft: false
description: mpv-Ciallo 完美继承原生 mpv 纯净、高效、低耗、高画质，同时通过插件组合补齐原生 mpv
  的短板：拥有现代化高颜值UI、精准缩略图预览、AI智能超分画质、全网流媒体解析、弹幕支持，是一款开箱即用、颜值与实力并存、兼顾日常观影与二次元专属需求的播放器，无广告、无付费、无捆绑。
